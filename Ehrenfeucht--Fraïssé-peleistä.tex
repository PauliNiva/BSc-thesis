...
Pelaaja II voittaa EF-pelin $EF_k(A, B)$, jos osittaisisomorfismi $A \rightarrow B$ toteutuu jokaisella kierroksella. Tästä seuraa, etää Pelaaja II olisi voittanut kaikki EF-pelit $EF_r(A, B), r \leq k$. Tämä ominaisuus voidaan ilmaista voittostrategian näkökulmasta seuraavasti:
\begin{lau}
