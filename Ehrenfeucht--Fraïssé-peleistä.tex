...
Ehrenfeucht--Fraïssé pelit ovat erityisen tärkeitä äärellisten mallien teoriassa ja sen sovelluksissa tietojenkäsittelytieteessä, koska Ehrenfeucht--Fraïssé-pelit ovat yksi harvoista malliteorian tekniikoista, jotka toimivat rajoituttaessa äärettömästä äärelliseen. Monet muut yleisesti käytetyt tekniikat, kuten kompaktiusteoreema, eivät toimi äärellisillä malleilla.}
