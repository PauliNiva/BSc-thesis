...
Tämä ei kuitenkaan päde peleillä $EF_t(A, B), k < t$. Esimerkiksi, jos edellä olevassa esimerkissä 18 pelattu kahden kierroksen EF-peli verkoille olisi pelattu kolmekierroksisena pelinä, voittostrategia olisikin Pelaajalla I. Hän yksinkertaisesti valitsisi yksi kerrallaan kaikki verkon $Y$ solmut, jolloin kolmannella kierroksella Pelaaja II ei enää pystyisi valitsemaan solmua, joka säilyttää relaatiot.
